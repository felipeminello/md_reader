...
/// real installed font on desktop, so it silently falls back to the default
/// UI font there. Request the platform's actual monospace font instead, with
/// `Courier New` (bundled on both Windows and macOS) as a shared fallback.
const List<String> _monospaceFontFamilies = <String>[
  'Courier New',
  'monospace',
];
